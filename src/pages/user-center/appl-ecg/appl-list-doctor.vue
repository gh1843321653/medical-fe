<template>
<!--当医生在“我的病人”列表点击心电申请，进入该就诊人的申请列表，所以该组件仅加载该就诊人的申请列表	-->
  <div class="applList">
		<div class="tab">
	      <div class="tab-item "  @click="addAppl">新建申请</div>
	      <div class="tab-item "  @click="moreSearch">搜索</div>
	    </div>
       <div class="addAppl" @click="addAppl" v-if="userRole=='1'"></div>
...
export default{
 ...
 data () {
  ...
  methods: {
  	addAppl:function(){
  		let query={
  			guahaoId:this.guahaoId,
  			patientName:this.patientName,
  			patientId:this.patientId
  		}
  		this.$router.push({path:'/appl-ecg-edit',query:query})
